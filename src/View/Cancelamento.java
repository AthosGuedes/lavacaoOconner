...
import javax.swing.table.DefaultTableModel;
        ...
        // acessando método de CancelamentoController através de obj de CancelamentoController
        // obj de AgendaController para acessar métodos

public class Cancelamento extends javax.swing.JFrame {
        // obj de CancelamentoController para acessar métodos
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        controller.CancelarAgendamento();
            // Exibe mensagem de agendamento cancelado
    ...
    // método para preencher tabela de agendamentos
private void ListarAgendamentos(){
        
        try {
                // cria obj de AgendamentoDAO
            AgendamentoDAO objAgendamentoDAO = new AgendamentoDAO();
            
            DefaultTableModel model = (DefaultTableModel) TabelaAgendamentos.getModel();
            model.setNumRows(0);
            
                // preenche a lista com informacoes do banco acessados atraves da classe AgendamentoDAO
            ArrayList<AgendamentoDTO> lista = objAgendamentoDAO.PesquisarAgendamento();
                
                // for que percorre toda a tabela
            for(int num = 0; num < lista.size(); num++){
                model.addRow(new Object[]{
                    // preenche (lista) com informações do banco na tabela de acordo com o contador do for. 
                    lista.get(num).getID(),
